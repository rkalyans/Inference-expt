...
output "agent_service_uri"     { value = module.agent.service_uri }
output "frontend_service_uri"  { value = module.frontend.service_uri }

output "service_accounts" {
  value = {
    agent_orchestrator = module.iam_prod.agent_orchestrator_sa_email
