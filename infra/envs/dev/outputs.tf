...
output "weather_service_uri" {
  value = module.weather.service_uri
}

output "inventory_service_uri" {
  value = module.inventory.service_uri
}
...
output "service_accounts" {
  value = {
    agent_orchestrator = module.iam_dev.agent_orchestrator_sa_email
